...
import { Clock, CheckCircle, XCircle, Plus, LayoutDashboard, Calendar, Users, User, List, Trash2, RotateCcw, Timer, BookOpen, Edit, ChevronRight, BarChart3, Lock, Sun, Moon, Repeat } from 'lucide-react';
        ...
        <div className="space-y-3 p-4 bg-gray-50 rounded-lg border dark:bg-gray-700/50 dark:border-gray-600">
            ...
            <div className="space-y-2 max-h-48 overflow-y-auto pr-2">
                ...
                {subtopics.map((sub) => (
                    ...
                    <div key={sub.id} className="bg-white p-2 border rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-600">
                        ...
                        <div className="flex items-center space-x-2 mb-2">
                            ...
                            <input
                                ...
                                className="flex-grow p-2 border border-gray-200 rounded-lg text-sm bg-white dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:placeholder-gray-400"
                            ...
                            {!isPeriodic && (
                                ...
                                <input
                                    ...
                                    className="w-20 p-2 border border-gray-200 rounded-lg text-sm text-center bg-white dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:placeholder-gray-400"
                        ...
                        {isPeriodic && (
                            ...
                            <textarea
                                ...
                                className="w-full p-2 border border-gray-200 rounded-lg text-sm bg-white dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:placeholder-gray-400"
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="flex space-x-2 mb-4 justify-center flex-wrap">
                    ...
                    <Button 
                        ...
                        variant={isTask ? 'primary' : 'outline'} 
                    ...
                    <Button 
                        ...
                        variant={isPeriodic ? 'primary' : 'outline'} 
                    ...
                    {isRevision ? (
                        ...
                        <div className="w-full sm:w-1/2 space-y-2">
                            ...
                            <input
                                ...
                                title="Last Revised Date (Used to calculate next review)"
                ...
                <div className="flex justify-end space-x-2 mt-4">
                    ...
                    <Button type="submit" variant="primary" disabled={loading || !topicName.trim() || !selectedSubjectId}>
                        ...
                        {loading ? 'Saving...' : `Save ${type.charAt(0).toUpperCase() + type.slice(1)} Item`}
...
const EditTopicModal = ({ userId, topic, subjects, isOpen, onClose, onSave }) => {
    ...
    return (
        ...
        <Modal isOpen={isOpen} onClose={onClose} title={`Edit ${topic?.type.charAt(0).toUpperCase() + topic?.type.slice(1)} Item: ${topic?.name || ''}`}>
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    {isRevision ? (
                        ...
                        <div className="w-full sm:w-1/2 space-y-2">
                            ...
                            <input
                                ...
                                title="Last Revised Date (Changing this recalculates next review)"
                ...
                <p className='text-xs text-yellow-600 bg-yellow-50 p-2 rounded-lg mb-4 dark:text-yellow-400 dark:bg-yellow-900/20'>
                    ...
                    {isRevision 
                        ...
                        ? `*Changing the Last Revised Date or Interval will update the next review date.`
...
const AppLogic = ({ userId, topics, subjects, allSubjects, deletedTopics }) => {
    ...
    const handleEditTopic = useCallback(async (topicId, name, subjectId, initialDateString, subtopics, enableLtr, taskDueDateString, revisionInterval) => {
        ...
        if (existingTopic.type === 'revision') {
            ...
            if (newStudyDateMs !== originalLastRevised || intervalChanged) {
                ...
                // Optionally reset history if date changed significantly
            ...
            <div className={`bg-white border-l-4 ${cardBorder} rounded-xl shadow-lg p-5 flex flex-col space-y-3 dark:bg-gray-800 dark:border-gray-700`}>
                ...
                <div className="flex justify-between items-start">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-2 dark:text-gray-400">
                            ...
                            {topic.type === 'revision' ? 'First Studied:' : topic.type === 'periodic' ? 'Last Revised:' : 'Created/Due:'} <span className="font-semibold text-gray-700 dark:text-gray-300">{initialStudyDate}</span>
                ...
                {hasSubtopics && (
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg border border-gray-100 max-h-40 overflow-y-auto dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <h5 className="text-xs font-bold text-gray-600 mb-2 border-b pb-1 dark:text-gray-400 dark:border-gray-500">Subtopics ({topic.subtopics.length})</h5>
                            ...
                            {topic.subtopics.map((sub, index) => (
                                ...
                                <li key={index} className="text-sm text-gray-800 dark:text-gray-200">
                                    ...
                                    {sub.description && (
                                        ...
                                        <p className="text-xs text-gray-600 mt-1 dark:text-gray-400 whitespace-pre-line break-words">{sub.description}</p>
                ...
                <div className="flex space-x-2 pt-2 border-t border-gray-100 dark:border-gray-700">
                    ...
                    {!isComplete && (
                        ...
                        >
                            ...
                            {topic.type === 'periodic' ? 'Mark Reviewed' : 'Mark Done'}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="p-4 bg-blue-50 rounded-lg border border-blue-200 flex items-center justify-between dark:bg-blue-900/20 dark:border-blue-800">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1 dark:text-gray-400">Total</p>

                                <p className="text-sm text-gray-500 dark:text-gray-400">Done: {todayDone} | Left: {todayLeft}</p>
                         ...
                         <div className="p-4 bg-purple-50 rounded-lg border border-purple-200 flex items-center justify-between dark:bg-purple-900/20 dark:border-purple-800">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">Done: {weeklyDone} | Left: {weeklyLeft}</p>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    {list.length > 0 ? (
                        ...
                        <div className="col-span-2 bg-white p-8 rounded-xl shadow-lg text-center text-gray-500 dark:bg-gray-800 dark:text-gray-400">
                            ...
                            <h3 className="text-2xl font-semibold mb-2 dark:text-gray-200">No Periodic Reviews Here</h3>
            ...
            <>
                ...
                <div className="mt-4 flex justify-center mb-6">
                    ...
                    >
                        ...
                        <Edit className="w-4 h-4 mr-2" /> Manage Subjects
                ...
                <div className="flex border-b border-gray-200 mb-6 sticky top-[170px] sm:top-[80px] bg-gray-50 z-10 dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <button onClick={() => setActivePeriodicTab('pending')} className={tabClasses('pending', activePeriodicTab)}>
                        ...
                        <Clock className="w-4 h-4 mx-auto mb-1" /> Pending ({periodicTabCounts.pending})

                    </button>

                    <button onClick={() => setActivePeriodicTab('missed')} className={tabClasses('missed', activePeriodicTab)}>

                        <XCircle className="w-4 h-4 mx-auto mb-1" /> Missed ({periodicTabCounts.missed})

                    </button>

                    <button onClick={() => setActivePeriodicTab('done')} className={tabClasses('done', activePeriodicTab)}>

                        <CheckCircle className="w-4 h-4 mx-auto mb-1" /> Done ({periodicTabCounts.done})
    ...
    const ReportsSection = () => {
        ...
        const totalItems = revisionTopics.length + taskTopics.length + periodicTopics.length;
   ...
   const toggleDarkMode = useCallback(() => {
    ...
    return (
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col dark:bg-gray-900">
                ...
                <div className="max-w-6xl mx-auto flex flex-col gap-2">
                    ...
                    <div className="flex space-x-2 pt-2 border-t border-gray-100 mt-2 sm:mt-0 sm:border-t-0 sm:pt-0 dark:border-gray-700">
                        ...
                        <Button
                            ...
                            variant={activeSection === 'periodic' ? 'primary' : 'outline'}
            ...
            <Modal isOpen={isAddSubjectModalOpen} onClose={() => setIsAddSubjectModalOpen(false)} title={`Add New Subject (${activeSection === 'revision' || activeSection === 'periodic' ? 'Revision/Periodic' : 'Task'})`}>
                ...
                <AddSubjectForm 
                    ...
                    subjectCollectionGetter={activeSection === 'revision' || activeSection === 'periodic' ? getRevisionSubjectsCollection : getTaskSubjectsCollection}
